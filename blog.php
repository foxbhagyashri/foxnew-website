        ...
        <div id="smooth-content">
            ...
            <main>
                ...
                <div class="tp-breadcrumb-area tp-breadcrumb-ptb include-bg"
                    data-background="assets/img/about-us/about-us-4/about-us-4-bg.png">
                    <div class="container container-1230">
                        <div class="row justify-content-center">
                            <div class="col-xxl-12">
                                <div class="tp-blog-heading-wrap p-relative pb-130">
                                    <span class="tp-section-subtitle pre tp_fade_anim">Blog Post <svg
                                            xmlns="http://www.w3.org/2000/svg" width="81" height="9" viewBox="0 0 81 9"
                                            fill="none">
                                            <rect y="4.04333" width="80" height="1" fill="black" />
                                            <path d="M77 8.00783L80.5 4.52527L77 1.04271" stroke="black"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>

                                    <h3 class="tp-blog-title tp_fade_anim smooth">Best blog <img
                                            src="assets/img/about-us/about-us-4/about-us-4-shape-1.png" alt=""> <br> <a
                                            href="#down"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                viewBox="0 0 20 20" fill="none">
                                                <path d="M9.99999 1V19M9.99999 19L1 10M9.99999 19L19 10" stroke="black"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-6">
                                                <div class="tp-blog-list-item-content">
                                                    <div class="tp-blog-list-item-tags">
                                                        ...
                                                        <span class="tp-blog-list-item-meta">Marketing</span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="tp-blog-list-item-title-box">
                                                    <h4 class="tp-blog-list-item-title">
                                                        <a class="tp-line-white"
                                                            href="benefits-of-digital-marketing.php">What are the
                                            ...
                                            <div class="col-lg-4">
                                                <div class="tp-blog-list-item-thumb text-lg-end">
                                                    <a href="benefits-of-digital-marketing.php"><img
                                                            src="assets/img/digital-marketing.webp"
