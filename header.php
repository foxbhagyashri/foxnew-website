<style>
/* Laptop screens (width between 1024px and 1440px) */
...
<header>
    ...
    <div class="tp-header-10-main header-transparent">
        ...
        <div class="tp-header-10-announcement-area p-relative include-bg"
            data-background="assets/img/home-10/header-img/announcement.png">
            <div class="tp-header-10-announcement-close">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-4 col-md-6 col-5">
                            <div class="tp-header-10-logo">
                                <a href="index.php"><img data-width="120" src="assets/img/fox Logo.png"
                                        alt="fox logo"></a>
                            </div>
                        </div>
                            ...
                            <div class="tp-header-10-box d-flex align-items-center justify-content-end ">
                                ...
                                <div class="tp-header-10-right d-flex align-items-center">
                                    ...
                                    <div class="animated-border-box radius-style-2">
                                        <a class="tp-btn-gradient sm p-relative" href="register.html">Sign
                                            up</a>
                                    </div>
                                </div> -->
    ...
    <div class="tp-offcanvas-wrapper @@class">
        ...
        <div class="tp-offcanvas-main">
            ...
            <div class="tp-offcanvas-contact">
                ...
                <ul>
                    <li><a href="tel:8879864151">+91 8879864151</a></li>
                    <li><a href="mailto:info@foxaircomm.com">info@foxaircomm.com</a></li>
                    <li><a href="#">Office No. BR1- 412/413, 4th floor, B wing, Jai Ganesh Vision, Akurdi, Pune
                            Maharashtra 411035 India</a></li>
                </ul>
            </div>
